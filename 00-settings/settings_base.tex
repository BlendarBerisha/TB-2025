...
\ExecuteBibliographyOptions{date=year} % n’affiche que l’année

\AtEveryBibitem{\clearfield{day}\clearfield{month}}
\AtEveryCitekey{\clearfield{day}\clearfield{month}}

\DeclareFieldFormat{labelday}{}
\DeclareFieldFormat{elabelday}{}
\DeclareFieldFormat{labelmonth}{}
\DeclareFieldFormat{elabelmonth}{}
